...
export function getProperties(_values: FiledropperPreviewProps, defaultProperties: Properties/*, target: Platform*/): Properties {
...
// export function check(_values: FiledropperPreviewProps): Problem[] {
...
// export function getCustomCaption(values: FiledropperPreviewProps, platform: Platform): string {
//     return "Filedropper";
// }
