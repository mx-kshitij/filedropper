...
export function Filedropper({ fileDataAttr, onDropAction, defaultText, dragText, buttonText, uploadImageType, uploadImage, uploadIcon, maxFileSize, acceptedFileTypes, acceptedFilesText }: FiledropperContainerProps): ReactElement {
    ...
    const onDropRejected = useCallback((rejectedFiles: FileRejection[]) => {
        ...
        setValidationMessage(`Files not accepted : ${rejectFileNames}`);
    ...
    const renderDropzone = () => {
        return isDragActive ?
            <div className="dropzone drag"><p>{dragText}</p></div>
            :
